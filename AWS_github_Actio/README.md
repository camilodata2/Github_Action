...
To deploy the CloudFormation template, we'll utilize the AWS CLI. Whether you're on Linux, macOS, or Windows, you can download the AWS CLI from the official website. First, copy this link curl "https://awscli.amazonaws.com/awscli-exe-linux-x86_64.zip" into your shell or terminal. Then, use the command 'unzip awscliv2.zip' and finally 'sudo ./aws/install'. And there you have it, now you've got the CLI installed and ready to use!
